...
function displayReplyForm(id){
    ...
    var blockquote = "<blockquote class='quote comment_quote p-2'>"+quote+"<img src='../build/images/cancel.svg' class ='px-2 delete_quote cursor' onclick='deleteQuote()'></img></blockquote>";
    $( "#comment_text" ).focus();
